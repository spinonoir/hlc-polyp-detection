...
The data set used was obtained from a link in the README.md file of the above repository.

I have modified the code to work with the data set and to work with the MaskRCNN model, by
adding bounding boxes labels from the image masks. 
"""
